package org.lineageos.dt2w.Matisse;
...
public class DT2WServiceMatisse extends Service {
    private static final String TAG = "DT2WServiceMatisse";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.matisse.dt2w", dt2wEnabled ? "1" : "0");
        }
